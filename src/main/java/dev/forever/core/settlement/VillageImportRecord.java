...
public record VillageImportRecord(
	...
	public static final Codec<VillageImportRecord> CODEC = RecordCodecBuilder.create(instance -> instance.group(
			SettlementCodecs.UUID_CODEC.fieldOf("proposal_id").forGetter(VillageImportRecord::proposalId),
			Identifier.CODEC.fieldOf("source_dimension").forGetter(VillageImportRecord::sourceDimension),
			BuildingBounds.CODEC.fieldOf("source_area").forGetter(VillageImportRecord::sourceArea),
			Codec.INT.fieldOf("source_villager_count").forGetter(VillageImportRecord::sourceVillagerCount),
			SettlementCodecs.boundedList(SettlementCodecs.UUID_CODEC, MAX_SELECTED_BUILDINGS,
					...
					.forGetter(VillageImportRecord::selectedBuildingIds),
			SettlementCodecs.boundedList(Codec.STRING, MAX_UNRESOLVED_ISSUES,
					"import unresolved issues").fieldOf("unresolved_issues")
					.forGetter(VillageImportRecord::unresolvedIssues)
	).apply(instance, VillageImportRecord::new));
