...
1. use Litematica, if its exact 26.2 build and format behaviour pass validation, for Ghost Plan rendering and material inspection;
2. use Effortless Building, if its exact 26.2 server/client build passes validation, for bounded Assisted Construction shapes;
