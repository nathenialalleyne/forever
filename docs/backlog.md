...
### MRH-010: Fail loudly when the Matcha baseline is absent or altered [Open; source-vs-spec evidence gap]
...
### MRH-013: Implement and package the approved diagnostic-only artifact [In progress; owner approval recorded]
