...
**Paths:** `docs/mod-research/dependency-lock.md`
...
**Build and tests:** Not compiled. The report was read and cross-checked with Packwiz files.

**Possible duplicated mechanic:** It records current dependencies but does not decide future candidates.

**Recommended destination:** Generated pack research report, unchanged and regenerated by `scripts/report-dependencies.sh`.
